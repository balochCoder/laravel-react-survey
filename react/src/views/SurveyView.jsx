      ...
      <form action="#" method='POST' onSubmit={onSubmit}>
        <div className="shadow sm:overflow-hidden sm:rounded-md">
          <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
            ...
            {/*  Description */}
            <div className="col-span-6 sm:col-span-3">
              <label htmlFor='description' className="block text-sm font-medium text-gray-700">Survey
                Description</label>
              <input
                type='text'
                name='description'
            ...
            {/*  Expiry Date */}
            <div className="col-span-6 sm:col-span-3">
              <label htmlFor='expire_date' className="block text-sm font-medium text-gray-700">Survey Expiry
                Date`</label>
              <input
                type='date'
                name='expire_date'
